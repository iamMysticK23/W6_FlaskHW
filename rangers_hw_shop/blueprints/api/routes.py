...
#internal imports 
from rangers_hw_shop.models import Customer, Product, ProdOrder, Order, db, product_schema, products_schema 
...
#creating READ data request for shop
@api.route('/shop')
@jwt_required()
def get_shop():
...
#creating READ data request for orders READ associated with 'GET' 
